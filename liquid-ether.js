...
(function () {
    // Helper to load Three.js if not present
    ...
    function initLiquidEther() {
        const containerId = 'liquid-ether-container';
        ...
        // Configuration
        const config = {
            colors: ['#4018CC', '#E080DD', '#9080CD'], // Slightly darker/less neon
            mouseForce: 12, // Reduced from 20 to make it less aggressive
            cursorSize: 80, // Slightly smaller cursor influence
            isViscous: true,
            viscous: 30,
        ...
        const Mouse = {
            ...
            init(container) {
                ...
                window.addEventListener('touchstart', this.onDocumentTouchStart.bind(this), { passive: true });
                window.addEventListener('touchmove', this.onDocumentTouchMove.bind(this), { passive: true });
                window.addEventListener('touchend', this.onTouchEnd.bind(this));
                document.addEventListener('mouseleave', this.onDocumentLeave.bind(this));
            },
        ...
        // ... Advection, ExternalForce, Viscous, Divergence, Poisson, Pressure, Simulation classes ...
        // Implementing simplified versions for brevity but maintaining logic
        ...
        class Simulation {
            ...
            createShaderPass() {
                ...
                this.externalForce = new ExternalForce({ cellScale: this.cellScale, cursor_size: this.options.cursorSize, dst: this.fbos.vel_1 });
        ...
        function init() {
            ...
            const autoDriver = new AutoDriver(Mouse, { lastUserInteraction: 0 }, {
            ...
            Mouse.onInteract = () => {
                autoDriver.manager.lastUserInteraction = performance.now();
